...
namespace EthansGameKit.AStar
{
	public sealed class GeneralPathfindingSpace : PathfindingSpace<Vector3, Vector3>
	{
		...
		public override Vector3 GetPositionUnverified(Vector3 key)
		{
			return key;
		}
		public override Vector3 GetIndexUnverified(Vector3 position)
		{
			return position;
		}
		public override List<Vector3> GetLinkSources()
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		protected override bool ContainsKey(Vector3 key)
		{
			return allPositions.Contains(key);
		}
